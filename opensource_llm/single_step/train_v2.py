...
from utils_v2 import create_and_prepare_model, create_datasets
...
class ModelArguments:
    ...
    lora_target_parameters: Optional[str] = field(
        default=None,
        metadata={"help": "comma separated list of specific target parameters to apply LoRA layers to (for expert models)"},
    )
...
def main(model_args, data_args, training_args):
    ...
    # print("FSDP kwargs:", getattr(plugin, "fsdp_kwargs", None))
